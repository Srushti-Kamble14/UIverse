    ...
    <div className="home-page">
      ...
      <section className="hero">
        ...
        <p className="hero-subtitle">
          A beginner-friendly React component library with clean CSS, zero
          dependencies, and a structure that's easy to contribute to.
        </p>
      ...
      <section className="contribute-section">
        <div className="contribute-inner">
          <div className="contribute-text">
            ...
            <p>
              UIverse is built for open-source contributors. Adding a new
              component takes just 3 steps — create, register, showcase. No
